...
### Content Quality
- E-E-A-T## Initial Assessment

**Automated Audit Commands Available:**
You can invoke automated parallel sub-agents and scripts using `/seo audit <url>`, `/seo technical <url>`, `/seo page <url>`, or `/seo google <command>`.

**Check for product marketing context first:**sues
- Readability scores
